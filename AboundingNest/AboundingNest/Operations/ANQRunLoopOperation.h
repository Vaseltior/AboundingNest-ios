...
enum ANQRunLoopOperationState {
    kANQRunLoopOperationStateInited, 
    kANQRunLoopOperationStateExecuting, 
    kANQRunLoopOperationStateFinished
};
typedef enum ANQRunLoopOperationState ANQRunLoopOperationState;

@interface ANQRunLoopOperation : NSOperation
{
    ANQRunLoopOperationState _state;
...
@property (nonatomic, assign, readonly ) ANQRunLoopOperationState    state;
...
@interface ANQRunLoopOperation (SubClassSupport)
